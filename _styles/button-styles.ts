...
export const buttonStyles = (
  ...
  classNames(
    "text-paragraph px-6 text-center py-2.5 flex justify-center gap-6 font-light ease-in-out duration-300 rounded-md",
    cssClasses,
    {
      ...
      "min-w-[150px] flex items-center": type === "submit",
    },
  );
