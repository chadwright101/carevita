...
const WhatsappButton = ({
  ...
  const href = `https://wa.me/27774766166?text=${encodeURIComponent(message)}`;
  ...
  return (
    <Link
      ...
      className={classNames(
        "desktop:hover:opacity-80 desktop:hover:cursor-pointer ease-in-out duration-300",
        cssClasses,
      )}
    >
      <div
