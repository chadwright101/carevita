  ...
  return (
    <div className="flex flex-col gap-8">
      {!formSubmited ? (
        <>
          <form onSubmit={handleSubmit} className="flex flex-col gap-10">
            ...
            <div className="flex flex-col gap-3">
              <label htmlFor="name" className="text-larger  font-extralight">
                Name:
              </label>
              <input
                type="text"
            ...
            {showMessage && (
              <>
                <div className="flex flex-col gap-2">
                  <label
                    htmlFor="phone"
                    className="text-larger  font-extralight"
                  >
                    Phone:
                  </label>
                  <input
            ...
            {showMessage && (
              <>
                ...
                {formError && (
                  <p className=" text-larger font-extralight italic -mt-4">
                    {formError}
                  </p>
                )}
              </>
        ...
        <p className=" text-larger font-extralight italic underline-offset-8 decoration-1">
