  ...
  return (
    <div>
      ...
      <ul className="mt-10 pt-10 border-t border-white flex flex-col gap-8 phone:gap-6 max-w-[1280px] mx-auto tablet:gap-2">
        <li className="grid grid-cols-1 gap-2 text-larger place-items-center phone:place-items-start phone:gap-0 phone:grid-cols-[175px_1fr] desktop:text-paragraph desktop:grid-cols-[165px_1fr]">
